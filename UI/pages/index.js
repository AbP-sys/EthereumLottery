  ...
  return (
    <div>
      ...
      <main className={styles.main}>
        ...
        <div className="container">
          <section className="mx-0 pt-6 my-6">
            <div className="columns">
              <div className="column is-two-thirds">
                <section className="mt-6">
                  <p className="has-text-white mx-2"><b>Ticket Price:</b> 20 USD</p>
                  <button onClick={enterLotteryHandler} className="button is-link is-large is-link is-rounded mt-3">Buy Ticket</button>
                </section>
                <section className="mt-6">
                  <p className="has-text-white mx-2"><b>Admin only:</b> Pick winner</p>
                  <button onClick={pickWinnerHandler} className="button is-large is-link is-rounded mt-3">End Lottery</button>
                </section>
                <section>
      ...
      <footer className={styles.footer}>
        <p className='has-text-white'>&copy; 2022 Team Semafour</p>
      </footer>
    </div>
  )
}